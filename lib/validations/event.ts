...
export const eventSchema = z.object({
    ...
    edition: z.number().int().min(1).max(99).optional().nullable(),
    location: z.string().max(200).optional().nullable(),
    timezone: z.string().default("Asia/Bangkok"),
    startDate: z.string().datetime().optional().nullable(),
    endDate: z.string().datetime().optional().nullable(),
    ticketUrl: z.string().url().max(500).optional().nullable(),
    ticketOpenDate: z.string().datetime().optional().nullable(),
    ticketCloseDate: z.string().datetime().optional().nullable(),
